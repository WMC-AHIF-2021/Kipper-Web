...
let worker = new Worker(new URL(require("df0934b964b65466")));
// Status code returns
 ...
 */ async function stopCode() {
    ...
    if (window.Worker) {
        ...
        worker = new Worker(new URL(require("df0934b964b65466")));
    } else alert("Your browser does not support web-workers! Aborting operation.");
    if (compiling) {
        switchToCompilerOutput();
...
},{"../prism/prism":"c7ZKT","df0934b964b65466":"hYuWd"}],"c7ZKT":[function(require,module,exports) {
/* PrismJS 1.28.0
...
},{}],"hYuWd":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('llfWI') + "compile-worker.e6655ca5.js";

},{"./helpers/bundle-url":"bxrDp"}],"bxrDp":[function(require,module,exports) {
"use strict";
var bundleURL = {
};
