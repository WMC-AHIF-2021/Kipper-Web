...
})({"69q5b":[function(require,module,exports) {
/**
 * Setup for a standard Kipper page.
 */ var _main = require("./main");
(()=>{
    // Update title using the JS API
    document.title = _main.UpdateTitle(_main.documentTitle);
    // For safety measures, if the JS changes are not recognised, manually update the HTML element
    Array.from(document.getElementsByTagName("title")).forEach((elem)=>{
        elem.innerHTML = document.title;
    });
    // Define OpenGraph Meta tags
    _main.DefineOpenGraphMetaTags(_main.openGraphMetaTags);
})();

},{"./main":"2mZi0"}],"2mZi0":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9op0l"}],"9op0l":[function(require,module,exports) {
...
},{}]},["69q5b"], "69q5b", "parcelRequiree125")

//# sourceMappingURL=index.12775784.js.map
